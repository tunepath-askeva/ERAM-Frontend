...
const EmployeeRaiseRequest = () => {
    ...
    const beforeUpload = (file) => {
        ...
        if (!allowedTypes.includes(file.type)) {
            message.error('Please upload PDF, DOC, DOCX, images, or text files only!');
            return false;
        }
    ...
    const handleSubmit = async (values) => {
        setLoading(true);
        try {
            // Create form data including files
                                ...
                                >
                                    <Upload.Dragger {...uploadProps}>
                                        ...
                                        <p className="ant-upload-hint">
                                            Support PDF, DOC, DOCX, images, and text files. Maximum 10MB per file.
                                        </p>
                                    </Upload.Dragger>
                                </Form.Item>
                            </Col>
                    ...
                    <div>
                        <Text type="secondary">
                            <ul style={{ paddingLeft: 20 }}>
                                ...
                                <li>HR or relevant department may contact you for additional information</li>
