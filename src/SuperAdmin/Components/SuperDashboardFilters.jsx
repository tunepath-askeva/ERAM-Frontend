      ...
      <Row gutter={[16, 16]}>
        <Col xs={24} sm={12} md={8} lg={6}>
          ...
          <Select
            ...
            value={Array.isArray(filters.branchId) ? filters.branchId : (filters.branchId === "all" ? [] : [filters.branchId])}
            onChange={(value) => setFilters(prev => ({ ...prev, branchId: value.length === 0 ? [] : value }))}
            allowClear
...
export default SuperDashboardFilters;
