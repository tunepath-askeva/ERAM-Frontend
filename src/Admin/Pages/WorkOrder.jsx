...
const WorkOrder = () => {
  ...
  const [workOrderToClone, setWorkOrderToClone] = useState(null);
  ...
  const showCloneModal = (workOrder) => {
    setWorkOrderToClone(workOrder);
    setClonedJobTitle(workOrder.title || ""); // Initialize with original title
  ...
  const getActiveStatusTag = (isActive) => {
    if (isActive === "active") {
      ...
      <Space size="small">
        ...
        {isDraft && (
          <>
            ...
            <Tooltip title="Clone Work Order">
              <Button
                type="text"
                size="small"
                icon={<CopyOutlined />}
                onClick={() => showCloneModal(workOrder)}
              />
            </Tooltip>
                  ...
                  <Card
                    ...
                    title={
                      ...
                      >
                        ...
                        {getActiveStatusTag(workOrder.isActive)}
                      </div>
                    }
              ...
              >
                ...
                <div style={{ marginBottom: "6px" }}>
                  <Text style={{ color: "#666", fontSize: "12px" }}>
                    ...
                    {workOrderToClone.isActive === "active" ? "Active" : "Inactive"}
                  </Text>
                </div>
                ...
                <div style={{ marginBottom: "6px" }}>
                  <Text style={{ color: "#666", fontSize: "12px" }}>
                    ...
                    {workOrderToClone.project?.name || "N/A"}
                  </Text>
                </div>
                ...
                <div>
                  <Text style={{ color: "#666", fontSize: "12px" }}>
                    <strong>Created:</strong>{" "}
                    {workOrderToClone.createdAt
                      ? new Date(workOrderToClone.createdAt).toLocaleDateString()
                      : "N/A"}
                  </Text>
                </div>
              </div>
