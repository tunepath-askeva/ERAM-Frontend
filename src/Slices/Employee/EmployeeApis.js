...
// const baseUrl = `${import.meta.env.VITE_API_BASE_URL}/api/employees`;

const baseUrl =
  window.location.hostname === "localhost"
    ? "http://localhost:5000/api/employees"
    : `https://${window.location.hostname}/api/employees`;
...
//   // your new server
//   baseUrl = "http://103.205.65.133/api/employees";
// } else {
//   // render server
//   baseUrl = "https://eram-backend-2gvv.onrender.com/api/employees";
// }
