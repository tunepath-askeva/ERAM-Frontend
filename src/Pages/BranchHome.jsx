...
const BranchHome = () => {
    const { branchUrl } = useParams(); // Get branch URL from route params
    ...
    useEffect(() => {
        if (branches?.branch && branchId) {
            const branch = branches.branch.find(b => b._id === branchId);
        ...
        <Layout>
            ...
            <div style={{ 
                ...
                <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
                    <Breadcrumb>
                        <Breadcrumb.Item>
                            <HomeOutlined onClick={handleGoBack} style={{ cursor: 'pointer' }} />
                        </Breadcrumb.Item>
                        <Breadcrumb.Item>
                            <a onClick={handleGoBack} style={{ cursor: 'pointer' }}>Branches</a>
                        </Breadcrumb.Item>
                                ...
                                <Space direction="vertical" size="large" style={{ width: '100%' }}>
                                    <div>
                                        <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px', marginBottom: '16px' }}>
                                            ...
                                            <div>
                                                <Text strong style={{ display: 'block', marginBottom: '4px' }}>Address:</Text>
                                        ...
                                        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
                                            ...
                                            <div>
                                                ...
                                                <Text
                                                    copyable={{ text: currentBranch.location.branch_phoneno }}
                                        ...
                                        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                                            ...
                                            <div>
                                                ...
                                                <Text
                                                    copyable={{ text: currentBranch.location.branch_email }}
                        ...
                        <Col xs={24} lg={12}>
                            ...
                            >
                                {currentBranch.services && currentBranch.services.length > 0 ? (
                                    ...
                                    <Text type="secondary">No services information available.</Text>
                                )}
                            </Card>
                        </Col>
                    </Row>
